...
import AboutOneImage from "/public/about-us/about-one.webp";
...
export const AboutOne: FC<Props> = ({ dict }) => {
  return (
    <AnimationWrapper
      initialY={0}
      className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8 lg:gap-12 xl:gap-20"
    >
      ...
      <div className="flex flex-col justify-center">
        ...
        <p className="text-primary text-base md:text-lg xl:text-xl leading-8 font-light">
          <span className="font-medium xl:font-semibold me-1">
            {dict.about.about_one.dr_mona_saad}
          </span>
          {dict.about.about_one.description_one}
          <br /> <br />
          {dict.about.about_one.description_two}
          <br /> <br />
          {dict.about.about_one.description_three}
        </p>
        <a
        ...
        >
          {dict.about.about_one.book_an_appointment}
        </a>
      </div>
    </AnimationWrapper>
  );
